...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const animateElements = document.querySelectorAll('.service-card, .project-card, .cert-card, .contact-card, .timeline-item');
        ...
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                ...
                statNumbers.forEach(stat => {
                    ...
                    const decimals = stat.textContent.includes('.') ? stat.textContent.split('.')[1].length : 0;
